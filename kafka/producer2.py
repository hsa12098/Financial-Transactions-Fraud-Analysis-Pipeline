...
try:
    ...
    # Load the bank simulation dataset
    logger.info("Loading bank simulation dataset...")
    df = pd.read_csv('/home/hamza/DE/20212619_DS463_final/financial-transactions-project/datasets/bank_sim.csv')
    logger.info(f"Loaded {len(df)} records from bank simulation dataset")
    ...
    producer.flush()
    logger.info("Finished streaming bank simulation dataset to Kafka")
